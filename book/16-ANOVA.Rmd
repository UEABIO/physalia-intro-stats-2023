...
```{task}
Can you produce a suitable/simple Figure for this dataset?
```
...
``{r, eval = T, echo = T, fig.cap = "Frogspawn hatching times at 13, 18 and 25 degrees Celsius. Boxplot displays median, hinges are first and third quartiles, whiskers extend from the hinge to 1.5X the interquartile range. Points represent individual frogspawns."}
