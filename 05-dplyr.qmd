...
Below we repeat the outcomes above, but with string matching - this has the benefit of reducing the chance of introducing NEW typos: 

In the example below we change all cases of sex to 'title' (capitalised first letter, the rest of the word is lower case)
